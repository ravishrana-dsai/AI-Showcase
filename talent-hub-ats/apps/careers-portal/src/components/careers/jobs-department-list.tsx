...
interface Job {
  ...
  /** When set (multi-org listing), links go to /[orgSlug]/jobs/[id]. */
  orgSlug?: string | null;
  /** Shown under the title when orgSlug is set. */
  orgName?: string | null;
}

interface Props {
  jobs: Job[];
  /** When provided, job links route to /[orgSlug]/jobs/[jobId] (org career site). */
  orgSlug?: string;
}
